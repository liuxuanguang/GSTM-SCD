...
class Options:
    def __init__(self):
        ...
        parser.add_argument("--Net_name", type=str, default="WUSUtoSECOND_GSTMSCD")
        parser.add_argument("--backbone", type=str, default="resnet34")
        parser.add_argument("--data_root", type=str, default=r"/media/lenovo/课题研究/博士小论文数据/长时序变化检测/Long-term-SCD/SECOND/New_SECOND")
