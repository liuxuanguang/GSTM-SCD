...
from models.proposed_MTGrootV3D import MTGrootV3D_SV3_WUSU_Random as Net
...
class Options:
    def __init__(self):
        ...
        parser.add_argument("--Net_name", type=str, default="WUSU_proposed_random_noignore_0415")
