...
# from models.proposed_MTGrootV3D import MTGrootV3D_SV3 as Net
...
from models.FC_Siam_conv import FC_Siam_conv as Net
...
class Options:
    def __init__(self):
        ...
        parser.add_argument("--Net_name", type=str, default="WUSU_FC_Siam_conv-0223")
        parser.add_argument("--backbone", type=str, default="resnet34")
        parser.add_argument("--data_root", type=str,
                            default=r"/media/lenovo/课题研究/博士小论文数据/长时序变化检测/Long-term-SCD/wusu512_process/NewWUSU")
...
class Trainer:
    ...
    def training(self, epoch):
        ...
        for i, (img1, img2, img3, mask1, mask2, mask3, mask_bn, id) in enumerate(tbar):
            ...
            tbar.set_description("Loss: %.3f, Semantic Loss: %.3f, Similarity Loss: %.3f" %
                                 (total_loss / (i + 1), total_loss_seg / (i + 1),
    ...
    def validation(self, epoch):
        ...
        with torch.no_grad():
            for img1, img2, img3, mask1, mask2, mask3, mask_bn, id in tbar:
                ...
                out1, out3 = self.model(img1, img3)
