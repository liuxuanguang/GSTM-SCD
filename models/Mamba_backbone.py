...
class Mamba_encoder(nn.Module):
    ...
    def forward(self, x1: torch.Tensor):
        ...
        x.append(x1.permute(0, 3, 1, 2))
        x1_1 = self.encoder_block1(x1)
        x.append(x1_1.permute(0, 3, 1, 2))
        x1_2 = self.encoder_block2(x1_1)
        x.append(x1_2.permute(0, 3, 1, 2))
        x1_3 = self.encoder_block3(x1_2)
        x.append(x1_3.permute(0, 3, 1, 2))
        x1_4 = self.encoder_block4(x1_3)  # b,h,w,c
        x.append(x1_4.permute(0, 3, 1, 2))
        return x
