...
from swin_umamba.GrootV.classification.models.tree_scan_utils.tree_scan_core import MinimumSpanningTree
...
def tree_scanning_core(xs, dts, As, Bs, Cs, Ds, delta_bias, origin_shape, h_norm):
    ...
    mst_layer = MinimumSpanningTree("Cosine", torch.exp)  # 创建最小生成树层
